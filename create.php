    ...
    if(empty($sname_err) && empty($fname_err) && empty($nic_err)&& empty($mobile_err) && empty($email_err) && empty($university_err)
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: create_sucess.html");
                    ...
                    <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						...
						<div class="col-sm-8">
							<div class="form-group <?php echo (!empty($nic_err)) ? 'has-error' : ''; ?>">
								<label>NIC</label>
									<input type="text" name="nic" class="form-control" placeholder="12345678V" value="<?php echo $nic; ?>">
						...
						<div class="col-sm-8">
							<div class="form-group <?php echo (!empty($mobile_err)) ? 'has-error' : ''; ?>">
								...
								<input type="text" name="mobile" class="form-control" placeholder="1234567890" value="<?php echo $mobile; ?>">
						...
						<div class="col-sm-8">
							<div class="form-group">
								<label>Email</label>
								<input type="text" name="email" class="form-control" placeholder="abc@gmail.com" value="<?php echo $email; ?>">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
									...
									<input type="text" name="university" class="form-control" placeholder= "university" value="<?php echo $university; ?>">
